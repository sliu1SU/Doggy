...
// ScreenPoint, ScreenD expect appropriate viewport
...
void Quad(vec3 p1, vec3 p2, vec3 p3, vec3 p4, bool solid, vec3 color, float opacity = 1, float lineWidth = 1, GLuint textureName = 0, int textureUnit = -1);
