...
// if FreeType not linked, undefine next line:
//#define FREETYPE_OK
...
const int nnicemax = 100;
char nicees[nnicemax][nnicemax];
int nnicee = 0;

const char *Nice(float f) {
	char *buf = (char *) nicees+nnicee*nnicemax;
	nnicee = ++nnicee % nnicemax;
//	static char buf[100];
